...
const mockAvailableTeamMembers: UserStub[] = [
  ...
  { id: "user3", name: "Layla Ibrahim", avatar: "/placeholder.svg?width=40&height=40" },
  { id: "user4", name: "Yusuf Ahmed", avatar: "/placeholder.svg?width=40&height=40" },
]
...
const mockRiskLibrary: Risk[] = [
  ...
  },
  {
    ...
    description: "Errors in financial reporting processes.",
    inherentRisk: "High",
  },
  {
    id: "RISK003",
    title: "Regulatory Non-Compliance",
    description: "Failure to adhere to industry regulations.",
    inherentRisk: "High",
  },
  {
    id: "RISK004",
    title: "System Downtime",
    description: "Critical system unavailability affecting operations.",
    inherentRisk: "Medium",
  },
]
...
export default function CreateNewAssignmentPage() {
  ...
  const handleConfirmTeamSelection = () => {
    const selectedMembers = mockAvailableTeamMembers.filter((m) => selectedTeamMemberIds.has(m.id))
  ...
  const handleConfirmRiskSelection = () => {
    const selectedRisks = mockRiskLibrary.filter((r) => selectedRiskIds.has(r.id))
          ...
          <div className="md:col-span-2 space-y-6">
            <Card>
              ...
              <CardContent>
                <Button type="button" variant="outline" disabled>
                  <PlusCircle className="mr-2 h-4 w-4" /> Add Task (Available after save)
                </Button>
                <p className="text-sm text-muted-foreground mt-2">Tasks can be added once the assignment is created.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  <CardTitle>Related Risks & Controls</CardTitle>
                  <CardDescription>Link existing risks from the library.</CardDescription>
                </div>
                <Button type="button" variant="outline" size="sm" onClick={handleManageRisks}>
                  <LinkIcon className="mr-2 h-4 w-4" /> Manage Linked Risks
                </Button>
              </CardHeader>
              <CardContent>
                    ...
                    {formState.linkedRisks.map((risk) => (
                      <div key={risk.id} className="flex items-center justify-between p-2 border rounded-md">
                        <div>
                          ...
                          <Badge variant="outline">{risk.inherentRisk}</Badge>
                        </div>
                        <Button
                          variant="ghost"
                          size="icon-sm"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Select name="impact" value={formState.impact} onValueChange={handleSelectChange("impact")}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <ScrollArea className="h-[300px] pr-4">
            <div className="space-y-2 py-4">
              {mockAvailableTeamMembers.map((member) => (
          ...
          <DialogFooter>
            ...
            <Button type="button" onClick={handleConfirmTeamSelection}>
              Confirm Selection
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={isRiskDialogOpen} onOpenChange={setIsRiskDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>Select risks from the library to link to this assignment.</DialogDescription>
          </DialogHeader>
          <ScrollArea className="h-[300px] pr-4">
            <div className="space-y-2 py-4">
          ...
          <DialogFooter>
            ...
            <Button type="button" onClick={handleConfirmRiskSelection}>
              Confirm Selection
            </Button>
          </DialogFooter>
        </DialogContent>
